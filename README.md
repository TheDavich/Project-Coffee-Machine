...
This project allows you to get a taste of Java. An important part of Java is classes, and this is what you will practice here. 

Try to work with loops and conditions and get more confident in Java programming.
...
Let's start with a program that makes you a virtual coffee, of course. 

But in this project, you will implement functionality that simulates a real coffee machine. It can run out of milk, run out of coffee beans, make different varieties of coffee, and take the money for making coffee.
...
Of course, all this coffee is not needed right now, so at this stage, the coffee machine doesn’t make any coffee.
...
The program should first request for water, then milk, then beans, then amount of cups.
...
No, I can make only 2 cups (s) of coffee
...
An espresso should be number 1 in the list, a latte as number 2, and a cappuccino as number 3.
Options also should be named "buy", "fill", or "take".
